...
void CTeam4SoundMachineDlg::OnBnClickedButtontest() // Erklärung vom Sound-Abspielen
{
	...
	mciSendString(_T("open C:\\sounds\\schick.mp3"), NULL, 0, NULL); // öffnet mp3
	mciSendString(_T("play C:\\sounds\\schick.mp3 from 0"), NULL, 0, NULL); //spielt mp3 bei jedem klick von vorne
